...
public:
    ...
    ToolBar(int a)
        ...
        , _imgStat(":imgStat")
    {
        initItem(0, "proj", tr("Projects2"), &_imgProj, tr(""), 20, 0, 0, 10);//broj menija i broj akcije
        initItem(1, "empl", tr("Employees2"), &_imgEmpl, tr(""), 20, 0, 0, 20);
        initItem(2, "req", tr("Requests2"), &_imgReq, tr(""), 20, 0, 0, 30);
        initItem(3, "srch", tr("Search2"), &_imgSrch, tr(""), 30, 0, 0, 10);
        initItem(4, "stat", tr("Statistics2"), &_imgStat, tr(""), 30, 0, 0, 20);
    }
};
