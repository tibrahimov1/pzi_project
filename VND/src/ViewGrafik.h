...
protected:
    ...
    td::INT4 _brojDana, _ukupDana, _sadTez, _ukupTez, _stanje;
    gui::Size _size;
    gui::Shape _linija;
    gui::Shape _moje;
...
public:
    ...
    void onDraw(const gui::Rect& rect) override
    {
        ...
        if (_stanje == -1) {
            ...
            _osa1.draw({ _size.width * 0.35,_size.height * 0.5 }, gui::Font::ID::SystemLargestBold, td::ColorID::Black);

            _osa1.draw({ _size.width * 0.35,_size.height * 0.7 }, gui::Font::ID::SystemLargestBold, td::ColorID::Black);

            gui::Transformation::restoreContext();
        }
        else if (_stanje == 0) {
            //Nema nijedan zavrsen tiket
            gui::DrawableString _osa1("NIJEDAN TIKET NIJE ZAVRŠEN");
            ...
            _osa1.draw({ _size.width * 0.3,_size.height * 0.3 }, gui::Font::ID::SystemLargestBold, td::ColorID::Black);

            _osa1.draw({ _size.width * 0.3,_size.height * 0.5 }, gui::Font::ID::SystemLargestBold, td::ColorID::Black);

            _osa1.draw({ _size.width * 0.3,_size.height * 0.7 }, gui::Font::ID::SystemLargestBold, td::ColorID::Black);
