...
class ViewGrafUser : public gui::Canvas
{
private:
...
public:
...

    {
        ...
        setBackgroundColor(td::ColorID::White);
    }
    ...
    void onDraw(const gui::Rect& rect) override
    {
        ...
        //StaviTacke(524, 81, 12,2); ovaj dio crta x0sa brojeve i oznake na osi
        ...
        //ovaj dio crta yOsa brojeve i oznake na osi
