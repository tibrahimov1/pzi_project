...
public:
    ...
    {
        setMargins(0, 0, 0, 0);
        _navigator.setItem(0, &_imgProj, tr("Project1"));
        _navigator.setItem(1, &_imgEmpl, tr("Employees1"));
        _navigator.setItem(2, &_imgReq, tr("Requests1"));
        _navigator.setItem(3, &_imgSrch, tr("Search1"));
        _navigator.setItem(4, &_imgStat, tr("Statistics1"));
        _hl.append(_navigator);
        _hl.append(_switcherView);
        setLayout(&_hl);
    }
